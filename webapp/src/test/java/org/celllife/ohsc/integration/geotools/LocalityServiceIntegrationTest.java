...
import static org.celllife.ohsc.integration.geotools.Localities.*;
...
public class LocalityServiceIntegrationTest {
    ...
    public void testFindAll() throws Exception {
        ...
        SimpleFeatureCollection localities = localityService.findAll();
    ...
    public void testFindByName() throws Exception {
        ...
        SimpleFeatureCollection localities = localityService.findByNameLike("J");
        SimpleFeatureIterator simpleFeatures = localities.features();
